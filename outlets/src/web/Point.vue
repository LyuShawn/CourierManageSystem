	...
	<div class="manage">
		<el-dialog title="提示" :visible.sync="dialogVisible" width="42%" :before-close="handleClose">
			<el-form ref="form" :rules="rules" :inline="true" :model="form" label-width="80px">
				<el-form-item label="快递id" prop="age">
					<el-input placeholder="请输入id" v-model="form.age"></el-input>
				</el-form-item>
				<el-form-item label="快递名称" prop="name">
					<el-input placeholder="请输入名称" v-model="form.age"></el-input>
				</el-form-item>
				<el-form-item label="寄出用户" prop="name">
					<el-input placeholder="请输入名称" v-model="form.name"></el-input>
				</el-form-item>
				<el-form-item label="联系方式" prop="addr">
					<el-input placeholder="请输入名称" v-model="form.addr"></el-input>
				</el-form-item>
				<el-form-item label="揽收状态" prop="sex">
					<el-select v-model="form.sex" placeholder="请选择">
						<el-option label="待揽收" :value="1"></el-option>
						<el-option label="已揽收" :value="0"></el-option>
					</el-select>
				</el-form-item>
		...
		<div class="common-tabel">
			<el-table stripe height="90%" :data="tableData" style="width: 100%">
				<el-table-column prop="age" label="快递id">
				</el-table-column>

				<el-table-column prop="name" label="快递名称">
				</el-table-column>
				<el-table-column prop="name" label="寄出用户">
				</el-table-column>
				<el-table-column prop="addr" label="联系方式">
				</el-table-column>
				<el-table-column prop="sex" label="揽收状态">
					<template slot-scope="scope">
						<span>{{ scope.row.sex == 1 ?'待揽收' : '已揽收' }}</span>
					</template>
				</el-table-column>
